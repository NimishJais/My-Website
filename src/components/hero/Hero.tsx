    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/90 border border-slate-200 shadow-2xs text-xs font-medium text-slate-700 mb-6"
        >
        ...
        <motion.div
          ...
          className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto pt-6 border-t border-slate-200/80"
        >
          {stats.map((st, i) => (
            <div
              key={i}
              className={`p-4 rounded-2xl bg-white border border-slate-200 shadow-xs border-t-4 transition-all duration-200 hover:-translate-y-1 hover:shadow-md cursor-default ${st.accent}`}
            >
